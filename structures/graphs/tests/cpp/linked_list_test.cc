...
static prb17::utils::structures::array<prb17::utils::test> build_tests() {
    ...
    tests.add(prb17::utils::test{"singleLinkedListPrint", &single_linked_list_print<T>});
    tests.add(prb17::utils::test{"doubleLinkedListPrint", &double_linked_list_print<T>});
